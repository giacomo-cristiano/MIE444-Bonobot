...
while RUN_MANUAL:
    ...
    if cmd == "L":
        ...
        Lidar_Data = Lidar_Data[::-1]
        # Localization comparison with requested LiDAR data to confirm Bonobot pose in x,y and orientation 
        lidar_angles = list(range(0, 360, 10))
        actual_lidar = dict(zip(lidar_angles, Lidar_Data[:36]))
        print("LiDAR Data:", actual_lidar)
        Estimated_Position = Compare_Lidar(Lidar_Data)
        ...
        #Localization Comparison with real-time UT data to confirm Bonobot pose in x,y and orientation. 
