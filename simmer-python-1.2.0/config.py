...
robot_start_position = [6, 42]  # Robot starting location (in)
robot_start_rotation = 180      # Robot starting rotation (deg)
robot_width = 7.28               # Robot width in inches
...
# Sensors [x (-ve is right, +ve is left),y (+ve is north, -ve is south)]
u0_info = { # front 
    'id': 'u0',
    'position': [0, 2.5],
    'height': 1,
